...
export const postsRepository = {
    async createPost(newPost: any): Promise<any> {
        try {
            ...
            console.log(
                `postsRepository.createPost error is occurred: ${error}`
            );
            return false;
        }
    },
    ...
    async updatePost({ id, input }: UpdatePostArgs): Promise<boolean> {
        try {
            ...
            console.log(
                `postsRepository.updatePost error is occurred: ${error}`
            );
            return false;
        }
    },
    ...
    async deletePostById(id: string): Promise<boolean> {
        try {
            ...
            console.log(
                `postsRepository.deletePostById error is occurred: ${error}`
            );
            return false;
        }
    },
