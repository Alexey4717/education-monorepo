...
export const blogsRepository = {
    async createBlog(newBlog: GetBlogOutputModel): Promise<boolean> {
        try {
            ...
            console.log(
                `blogsRepository.createBlog error is occurred: ${error}`
            );
            return false;
        }
    },
    ...
    async updateBlog({ id, input }: UpdateBlogArgs): Promise<boolean> {
        try {
            ...
            console.log(
                `blogsRepository.updateBlog error is occurred: ${error}`
            );
            return false;
        }
    },
    ...
    async deleteBlogById(id: string): Promise<boolean> {
        try {
            ...
            console.log(
                `blogsRepository.deleteBlogById error is occurred: ${error}`
            );
            return false;
        }
    },
